...
import { NagruzkaLine, NagruzkType } from '../types';
...
function processRowWrapperFunc(teacher: string, type: NagruzkType, sem:number) {
  return (x: Row) => processRow(x, teacher, type, sem);
}
