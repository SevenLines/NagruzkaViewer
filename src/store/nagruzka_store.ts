...
import {
  getNagruzkaLineTotal, GetNagruzkTypeInfo,
  MoveCellInfo,
  NagruzkaCellType,
  NagruzkaConfig,
  NagruzkaLine,
...
export default class NagruzkaStore {
  nagruzka: Array<NagruzkaLine> = [];
  baseNagruzka: Array<NagruzkaLine> = [];
  selectedTeacher: string = "";
  selectedSem: number = 1;
  clickedPosition: { left: number, top: number } | null = null;
  moveCellInfo: MoveCellInfo | null = null;
  clickedRow: NagruzkaLine | null = null;
  hoveredCellType: NagruzkaCellType | null = null;
  hoveredRow: NagruzkaLine | null = null;
