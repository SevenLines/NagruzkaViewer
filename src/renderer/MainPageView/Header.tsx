...
const Header = observer(() => {
  ...
  const totalShtat = round(store.totalBySem1.shtat + store.totalBySem2.shtat, 2);
  const totalChasovik = round(store.totalBySem1.chasovik + store.totalBySem2.chasovik, 2);
  const totalSovmishenie = round(store.totalBySem1.sovmeshenie + store.totalBySem2.sovmeshenie, 2);
